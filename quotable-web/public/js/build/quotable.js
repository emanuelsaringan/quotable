    ...
    render: function() {
        return (
            React.DOM.div({className: "quoteLogo"}, 
                React.DOM.a({href: "http://twitter.com/share?url=" + encodeURIComponent("http://localhost:3000") + "&text=" + this.props.item.text, target: "_blank"}, 
                    React.DOM.img({className: "shareIcon", src: "/img/btnShareTwitter.png", alt: "Twitter"})
                ), 
